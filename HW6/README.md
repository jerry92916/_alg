...
我的理解:  
1.爬山演算法:爬山法使用的是一種「隨機摸索」的策略，它不計算導數，而是單純嘗試在當前位置附近隨機找一點，只要比現在好就往那邊跳。  
2.貪婪法:貪婪法採取盡可能地嘗試當前最優路徑，配合文章中提到的概念，尋找使誤差最小化的參數組合，在每一輪中，它會從定義好的四個移動方向中挑選當下最好的一個方向，直到所有方向都無法再降低誤差為止。  
